...
F_max = 5  # Максимальная частота
Dt_values = [2, 4, 8, 16]  # Кроки дискретизации
F_filter = 12  # Полоса фильтра
...
# Визуализация дискретизованных сигналов
...
plt.savefig('C:/Users/Евгений/IdeaProjects/TIC_Vansovich_529/SignalProcessing/figures/discrete_signals.png', dpi=600)

# Визуализация спектров дискретизованных сигналов
fig, ax = plt.subplots(2, 2, figsize=(21 / 2.54, 14 / 2.54))
for i in range(2):
        for j in range(2):
                idx = i * 2 + j
...
plt.savefig('C:/Users/Евгений/IdeaProjects/TIC_Vansovich_529/SignalProcessing/figures/discrete_spectrums.png', dpi=600)

# Визуализация восстановленных сигналов
fig, ax = plt.subplots(2, 2, figsize=(21 / 2.54, 14 / 2.54))
for i in range(2):
        for j in range(2):
                idx = i * 2 + j
...
plt.savefig('C:/Users/Евгений/IdeaProjects/TIC_Vansovich_529/SignalProcessing/figures/restored_signals.png', dpi=600)
...
plt.savefig('C:/Users/Евгений/IdeaProjects/TIC_Vansovich_529/SignalProcessing/figures/error_variance.png', dpi=600)
...
plt.savefig('C:/Users/Евгений/IdeaProjects/TIC_Vansovich_529/SignalProcessing/figures/snr.png', dpi=600)
